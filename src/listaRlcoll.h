...
void Cancella(int pos, lista &l)
//cancella l' elemento in posizione pos. pos � compresa tra 0 e n-1. Per pos =0 abbiamo la cancellazione in testa. Per pos=n-1 abbiamo la cancellazione in coda. 
{
    if (l == NULL) cout << "lista vuota";
    else if (pos < 0) cout << pos << "negativo";
    else if (pos == 0) {
        elemento *p1 = l;
        l = l->succ;
        delete p1;
